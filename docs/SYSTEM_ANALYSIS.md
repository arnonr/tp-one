...
### 5.6 ระบบติดตามแผนปฏิบัติการรายปี (Annual Operational Plan)
...
| ID | ข้อกำหนด | ความสำคัญ |
|----|---------|----------|
| FR-PLAN-01 | Admin สร้างแผนปฏิบัติการรายปีได้ (ระบุปี, ชื่อแผน) | สูง |
...
| FR-PLAN-11 | ดูประวัติการอัปเดตทั้งหมดของตัวชี้วัด (ใคร, เมื่อไหร่, รายละเอียด) | กลาง |
| FR-PLAN-12 | Export รายงานแผนปฏิบัติการเป็น PDF/Excel | กลาง |

**ตัวอย่างข้อมูล:**

    目前要求的结构 (tree)
    แผนปฏิบัติการรายปี 2569
