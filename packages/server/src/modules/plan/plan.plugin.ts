...
export const planPlugin = new Elysia({ prefix: '/api/plans' })
  ...
  // ===== OLD: Plan → Category → Indicator (kept for backward compat) =====
  ...
  // Categories (nested under plan) — old structure
  ...
  // Indicators (nested under category) — old structure
  ...
  // Indicator Updates — old structure
